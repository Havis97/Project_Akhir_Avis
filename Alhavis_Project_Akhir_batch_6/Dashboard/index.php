    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="#" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Daftar Alumni</a>
            ...
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <table class="table table-dark">
                    ...
                    <tbody>
                        ...
                        <?php $daftar = mysqli_query($koneksi, "SELECT * FROM alumni WHERE status = 'Tunggu'"); ?>
                        <?php while ($hasil = mysqli_fetch_assoc($daftar)) { ?>
                            <tr>
                                <td>
                                    <?php echo $hasil['id_alumni']; ?>
                                </td>
                                <td>
                                    <?php echo $hasil['nama']; ?>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="../database/proses_setuju.php?id_alumni =<?php echo $hasil['id_alumni'] ?>"><button type="submit">Belum Diterima</button></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
