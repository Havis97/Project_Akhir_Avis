                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    $produk = mysqli_query($koneksi, "SELECT p.*, k.kategori
                                    FROM produk P
                                    JOIN kategori_produk k ON k.id_kategori =  p.id_kategori
                                    WHERE p.id_alumni='$id_alumni'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $item['persen'] ?></td>
                                            <td><?= $item['rating'] ?></td>
                                            <td><img src="../assets/<?php echo $item['gambar'] ?>" width="200px" alt="GAMBAR KOSONG"></td>
                                            <td><a href="edit_produk.php?id_produk=<?php echo $item['id_produk'] ?>;" type="button" class="btn btn-primary m-0">Edit</a></td>
                                            <td><a href="../../database/proses_hapus_produk.php?id_produk=<?php echo $item['id_produk'] ?>" type="button" class="btn btn-primary m-0">Hapus</a></td>
                                        </tr>
                                </tbody>
                            <?php } ?>
                            </table>
