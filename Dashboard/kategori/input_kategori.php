        ...
        <div class="container-fluid pt-4 px-4">
            <div class="row g-4">
                <div class="col-sm-12 col-xl-6">
                    <form action="../../database/Proses_tambah_kategori.php" method="POST" enctype="multipart/form-data">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Input Kategori</h6>
                            ...
                            <div>
                                <button class="btn btn-primary w-100 m-2" type="submit">Upload</button>
                            </div>
                        </div>
                    </form>
                </div>
